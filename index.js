if (process.env.NODE_ENV !== 'production') {
  ...
  return new Promise((resolve, reject) => {
    blobService.getBlobToText(containerName, blobName, (err, data) => {
      ...
      const blobName = "amsaccount1.txt"; // "dialogueSample.mp4"; //
      const content = "hello Blob SDK";
      const localFilePath = "../amsaccount1.txt"; // "../dialogueSample.mp4"; //
      let response;
...
const subscriptionId = "95e2c3e3-b0a9-4419-8a74-a3f87c8f97da";
const accountName ="amsaccount1";
const region ="South India";
const aadClientId = "0b6dd432-5923-4e1c-9692-5eac36fa7eef";
const aadSecret ="DTb0Sgwc4eMdziNRYY9ICKx2WcAgf2WNIKboW3xYNYw=";
const aadTenantId ="f45d2ebe-dd85-4295-9706-62b292e77dfd";
const resourceGroup ="amsResourceGroup";

// args
const outputFolder = "C:\\Users\\abhishek.nigam01\\Desktop\\media-services-v3-node-tutorials-master\\VIOutput";
...
// const inputUrl = "null";
// const inputFile = "C:\\Users\\abhishek.nigam01\\Desktop\\dialogueSample.mp4";
